    ...
    ***************************************************************************** */
    ...
    var CacheObserver = (function () {
        ...
        CacheObserver.prototype.removeStaleElements = function () {
            var e_1, _a;
            var staleElements = __spreadArray([], __read(document.querySelectorAll('[data-turbo-cache="false"]')));
            try {
    ...
    var StreamElement = (function (_super) {
        ...
        Object.defineProperty(StreamElement.prototype, "duplicateChildren", {
            get: function () {
                var _a;
                var existingChildren = this.targetElements.flatMap(function (e) { return __spreadArray([], __read(e.children)); }).filter(function (c) { return !!c.id; });
                var newChildrenIds = __spreadArray([], __read((_a = this.templateContent) === null || _a === void 0 ? void 0 : _a.children)).filter(function (c) { return !!c.id; }).map(function (c) { return c.id; });
