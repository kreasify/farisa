document.addEventListener('alpine:init', () => {
    Alpine.data('checkout', () => ({
        ...
        sendWa(products, subtotal, berat) {
            ...
            const link = `https://api.whatsapp.com/send?phone=${this.user.whatsapp}&text=${header}${name}${hp}${email}${address}${kurir}${pembayaran}${product_list}${sub_total}${ongkir}${total_bayar}`;
