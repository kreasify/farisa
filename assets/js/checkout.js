document.addEventListener('alpine:init', () => {
    Alpine.data('checkout', () => ({
        ...
        sendWa(products, subtotal, berat) {
            ...
            const catatan = `*Catatan*%20%20%3A%20${this.note}%0A`;
            ...
            const link = `https://api.whatsapp.com/send?phone=${this.user.whatsapp}&text=${header}${name}${hp}${email}${address}${pembayaran}${kurir}${product_list}${sub_total}${ongkir}${total_bayar}`;
