document.addEventListener('alpine:init', () => {
    Alpine.data('checkout', () => ({
        ...
        sendWa(products, subtotal, berat) {
            ...
            const payment = `*Pembayaran*%20%20%3A%20${this.paymentNumber}%20a/n%20${this.paymentAccount}%20(${this.payment})%0A`;
            ...
            const link = `https://api.whatsapp.com/send?phone=${this.user.whatsapp}&text=${header}${name}${hp}${email}${address}${kurir}${payment}${product_list}${sub_total}${ongkir}${total_bayar}`;
