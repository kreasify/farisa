    ...
    Alpine.data('ads', () => ({
        ...
        <div class="related__ads pt-6">
            <div class="grid grid-cols-12 lg:grid-cols-10 gap-3 lg:gap-6">
                ...
                <div class="ads__item col-span-6 md:col-span-3 lg:col-span-2 transition duration-500 ease-ease hover:shadow-lg">
                    <div class="ads__item__image relative bg-body-primary">
                        <a class="ads__item__link" x-bind:href="item.url">
                    ...
                    <div class="ads__item__info py-3 px-2">
                        <a class="ads__item__link" x-bind:href="item.url">
                            <h3 class="ads__item__title text-sm lg:text-base text-heading font-heading font-medium mb-1" x-text="item.title"></h3>
                        </a>
                        <template x-if="item.price">
                        <p class="ads__item__price mb-3">
