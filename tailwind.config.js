...
module.exports = {
	...
	purge: {
		...
		mode: 'all',
		options: {
			safelist: ['table', 'th', 'tr', 'td', 'w-screen', 'h-screen', 'max-w-screen-lg', 'aspect-w-6', 'bg-opacity-60', text-body bg-body-text', 'pl-1', 'aspect-h-7', 'black',  'autoComplete_result', 'autoComplete_highlighted', 'autoComplete_selected'],
		}
	},
	theme: {
		extend: {
